...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <?= Html::beginTag('div', ['class' => 'row col-lg-4']) ?>
            <?= $form->field($order, 'verifyCode')->widget(\yii\captcha\Captcha::className(),
                [
            ...
            <?= Html::beginTag('div', ['class' => 'col-lg-5', 'style' => 'margin: 3% 0 0 -11%;']) ?>
